...
import * as services from 'wax-prosemirror-services';
...
export default {
  ...
  services: [
    new services.InlineAnnotationsService(),
    new services.AnnotationToolGroupService(),
    new services.BaseService(),
    new services.BaseToolGroupService(),
    new services.FullScreenService(),
    new services.FullScreenToolGroupService(),
  ],
};
*/
